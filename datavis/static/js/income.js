...
map.addSource("income", {
    type: "geojson",
    data: "/static/geojson/income.geojson"
});
...
[
    "interpolate",
    ["linear"],
    ["to-number", ["get", "Income per capita"]],
    7394.0, "#0d0887",
89845.0, "#cc4778"
]
    ,
...
map.on("click", "Incomepercapita", function(e) {
    new mapboxgl.Popup()
        .setLngLat(e.lngLat)
        .setHTML("<b>Income per capita:</b> " + e.features[0].properties["Income per capita"])
        .addTo(map);
});
